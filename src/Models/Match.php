...
class Match extends Model 
{
  ...
  {
    return $this->belongsToMany('CompanyHike\Sherpa\Models\User')->using('\CompanyHike\Sherpa\Models\MatchUser')->withPivot(['company_name', 'avatar', 'bankrupt', 'dismissed', 'ceo_parameters', 'results', 'created_at']);
  }

  public function getPlayersAttribute()
  {
    return Arr::get($this->match_parameters, 'players', null);
  }

  public function getNameAttribute()
  {
    return Arr::get($this->match_parameters, 'name', null);
  }

  public function getStagesAttribute()
  {
    return Arr::get($this->match_parameters, 'stages', null);
  }

  public function getTypeAttribute()
  {
    return Arr::get($this->match_parameters, 'type', null);
  }
  ...
  public function hasGovermentDecisions(){
    if($this->match_parameters['type'] == 'scenario'){
      return true;
    }else{
