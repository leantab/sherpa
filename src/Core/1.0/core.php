...
class Core
{
  ...
  private function init_t0()
  {
    ...
    $game_parameters['opening_cash_ratio'] = rand($vars_proficiency_rate[$this->game->game_parameters['proficiency_rate']]['opening_cash_min'], $vars_proficiency_rate[$this->game->game_parameters['proficiency_rate']]['opening_cash_max']) / 100;
    $game_parameters['price_t0_leverage'] = rand($vars_proficiency_rate[$this->game->game_parameters['proficiency_rate']]['price_t0_min'], $vars_proficiency_rate[$this->game->game_parameters['proficiency_rate']]['price_t0_max']) / 100;
